...
namespace MCGA.WebSite.Constants.TipoDocumentoController
{
    public class TipoDocumentoControllerRoute
    {
        public const string GetCreate = ControllerName.Home + "GetCreate";
