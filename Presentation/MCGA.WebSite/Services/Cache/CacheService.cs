...
namespace WebApplication1.Services.Cache
{
    public static class DataCacheSetting
    {
        ...
        {
            public const string Key = "TipoDia";
            public static readonly TimeSpan SlidingExpiration = TimeSpan.FromHours(1);
        }
        public static class TipoDocumento
        {
            public const string Key = "TipoDocumento";
            public static readonly TimeSpan SlidingExpiration = TimeSpan.FromHours(1);
        }
        public static class TipoReserva
        {
            public const string Key = "TipoReserva";
            public static readonly TimeSpan SlidingExpiration = TimeSpan.FromHours(1);
        }
        public static class TipoSexo
        {
            public const string Key = "TipoSexo";
            public static readonly TimeSpan SlidingExpiration = TimeSpan.FromHours(1);
        }
        public static class Especialidad
        {
            public const string Key = "Especialidad";
            public static readonly TimeSpan SlidingExpiration = TimeSpan.FromHours(1);
        }
        public static class Profesional
        {
            public const string Key = "Profesional";
            public static readonly TimeSpan SlidingExpiration = TimeSpan.FromHours(1);
        }
    }
    public class DataCache
    {
        ...
        public IList<TipoDia> TipoDiaList()
        {

            var lista = _cacheService.GetOrAdd(DataCacheSetting.TipoDia.Key, () =>
            {
                TipoDiaProcess component = new TipoDiaProcess();
